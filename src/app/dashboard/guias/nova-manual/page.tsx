...
export default async function NovaGuiaManualPage() {
    ...
    return (
        <div className="p-4 sm:p-8 max-w-4xl mx-auto min-h-screen pb-12">
            ...
            <div className="bg-white p-6 sm:p-10 rounded-3xl border border-slate-200 shadow-xl relative mt-4">
